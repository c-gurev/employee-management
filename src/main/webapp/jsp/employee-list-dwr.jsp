...
<head>
    ...
    <script src="${pageContext.request.contextPath}/dwr/interface/EmployeeServiceDWR.js"></script>
    <script src="../js/employee-dwr.js"></script>
    <script>
...
<div class="container mt-4">
    ...
    <div class="mb-3 d-flex justify-content-between">
        ...
        <a href="${pageContext.request.contextPath}/jsp/employee-list.jsp">Servlet/jQuery</a>
    </div>
